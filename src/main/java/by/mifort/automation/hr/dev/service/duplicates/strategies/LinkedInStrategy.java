...
/**
 * Way to find duplicates by value of candidate's LinkedIn
 *
 ...
 */
@Component
public class LinkedInStrategy implements DuplicatesStrategy {
    ...
    public LinkedInStrategy(EntityConverter<CandidateAttributes, CandidateAttributesDto> converter, CandidateAttributesRepository attributesRepository) {
    ...
    public DuplicatesStrategyName getStrategyName() {
        return DuplicatesStrategyName.LINKEDIN;
    }
}
