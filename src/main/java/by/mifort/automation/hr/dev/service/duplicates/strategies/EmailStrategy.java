...
/**
 * Way to find duplicates by value of candidate's Email
 *
 ...
 */
@Component
public class EmailStrategy implements DuplicatesStrategy {
    ...
    public EmailStrategy(EntityConverter<CandidateAttributes, CandidateAttributesDto> converter, CandidateAttributesRepository attributesRepository) {
    ...
    public DuplicatesStrategyName getStrategyName() {
        return DuplicatesStrategyName.EMAIL;
    }
}
