...
/**
 * Way to find duplicates by value of candidate's GitHubID
 *
 ...
 */
@Component
public class GitHubIDStrategy implements DuplicatesStrategy {
    ...
    public GitHubIDStrategy(EntityConverter<CandidateAttributes, CandidateAttributesDto> converter, CandidateAttributesRepository attributesRepository) {
    ...
    public DuplicatesStrategyName getStrategyName() {
        return DuplicatesStrategyName.GITHUB_ID;
    }
}