...
/**
 * Way to find duplicates by value of candidate's FacebookID
 *
 ...
 */
@Component
public class FacebookIDStrategy implements DuplicatesStrategy {
    ...
    public FacebookIDStrategy(EntityConverter<CandidateAttributes, CandidateAttributesDto> converter, CandidateAttributesRepository attributesRepository) {
    ...
    public DuplicatesStrategyName getStrategyName() {
        return DuplicatesStrategyName.FACEBOOK_ID;
    }
}