...
/**
 * Way to find duplicates by value of Mobile candidate's phone number
 *
 ...
 */
@Component
public class PhoneStrategy implements DuplicatesStrategy {
    ...
    public PhoneStrategy(EntityConverter<CandidateAttributes, CandidateAttributesDto> converter, CandidateAttributesRepository attributesRepository) {
    ...
    public DuplicatesStrategyName getStrategyName() {
        return DuplicatesStrategyName.PHONE;
    }
}
