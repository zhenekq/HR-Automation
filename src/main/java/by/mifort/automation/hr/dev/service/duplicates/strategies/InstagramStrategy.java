...
/**
 * Way to find duplicates by value of candidate's Instagram
 *
 ...
 */
@Component
public class InstagramStrategy implements DuplicatesStrategy {
    ...
    public InstagramStrategy(EntityConverter<CandidateAttributes, CandidateAttributesDto> converter, CandidateAttributesRepository attributesRepository) {
    ...
    public DuplicatesStrategyName getStrategyName() {
        return DuplicatesStrategyName.INSTAGRAM;
    }
}
